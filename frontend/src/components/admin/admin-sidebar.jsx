...
const sidebarItems = [
  ...
  { title: "Ledger", href: "/admin/ledger", icon: Book },
...
export function AdminSidebar({ isOpen, onClose, className }) {
  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col text-black dark:text-white dark:bg-neutral-900">
  ...
  return (
    <>
      ...
      <div className="lg:hidden ">
        ...
        <div
          className={cn(
            "fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform adminsidebar transition-transform duration-10 ease-in-out",
